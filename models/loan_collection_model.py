...
class LoanCollection(db.Model):
    ...
    # loan_id = db.Column(db.Integer, db.ForeignKey('loans.id'), nullable=True)  # Temporarily disabled for migration
    ...
    # loan = db.relationship('Loan', backref='loan_collections_list')  # Temporarily disabled for migration
